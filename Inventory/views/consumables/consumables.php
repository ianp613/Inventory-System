<div id="consumables">
    ...
    <div hidden id="cons">
        ...
        <a href="https://idcsi-officesuites.com:8080/aims2/login.php" class="btn btn-dark wd-150 alert-dark fw-bold"><span class="fa fa-external-link"></span><div>AIMS</div></a>
        <div class="mt-4"></div>
