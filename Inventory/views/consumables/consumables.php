<div id="consumables">
    ...
    <div hidden id="cons">
        ...
        <a target="_blank" href="https://idcsi-officesuites.com/aims2/login.php" class="btn btn-dark wd-150 alert-dark fw-bold"><span class="fa fa-external-link"></span><div>AIMS v2</div></a>
        <div class="mt-4"></div>
