<div id="consumables" class="theme-card theme-card-dark">
    ...
    <div hidden id="cons">
        ...
        <a target="_blank" href="https://idcsi-officesuites.com/aims2/login.php" class="btn btn-warning wd-150 alert-warning fw-bold"><span class="fa fa-external-link"></span><div>AIMS</div></a>
        <div class="mt-4"></div>
    ...
    <div hidden id="cons_request">
        <h6 class="f-i text-danger alert-danger p-3 rounded-3 mb-3 mt-2 blink-1">*Note: If your request is not approved after an hour, please send a message to wherever you sent your request.</h6>
