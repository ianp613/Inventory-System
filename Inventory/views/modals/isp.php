    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <select name="" id="configuration" class="form-control mt-2">
                ...
                <div class="row mb-2 mt-2">
                    <div class="col-md-6">
                        ...
                        <input readonly required type="text" name="dns1" id="dns1" class="form-control">
                    </div>
                    <div class="col-md-6">
            ...
            <div class="modal-body">
                ...
                <div class="row mb-2 mt-2">
                    <div class="col-md-6">
                        ...
                        <input readonly required type="text" name="edit_dns1" id="edit_dns1" class="form-control">
                    </div>
                    <div class="col-md-6">
...
<div class="modal fade" id="add_isp_configuration" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h6>Add ISP Configuration</h6>
            </div>
            <div class="modal-body">
                <label for="configuration_name" class="mb-2">Name</label>
                <input required type="text" name="configuration_name" id="configuration_name" class="form-control">
                <div class="row mb-2 mt-2">
                    <div class="col-md-6">
                        <label for="configuration_subnet" class="mb-2">Subnet Mask</label>
                ...
                <div class="row mb-2 mt-2">
                    <div class="col-md-6">
                        <label for="configuration_dns1" class="mb-2">DNS 1</label>
                        <input required type="text" name="configuration_dns1" id="configuration_dns1" class="form-control">
                    </div>
                    <div class="col-md-6">
                        <label for="configuration_dns2" class="mb-2">DNS 2</label>
                        <input required type="text" name="configuration_dns2" id="configuration_dns2" class="form-control">
                    </div>
                </div>
            </div>
            <div class="modal-footer">
